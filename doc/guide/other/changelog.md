...
## v0.6
[gitee](https://gitee.com/microapp/bxmall/releases/v0.6) [github](https://github.com/microapp-store/bxmall/releases/tag/v0.6)
### Issues
- echarts随着窗口缩放自适应
- 用户个人中心增加收藏商品管理功能
- 对接快递鸟物流查询服务
...
## v0.5
[gitee](https://gitee.com/microapp/bxmall/releases/v0.5) [github](https://github.com/microapp-store/bxmall/releases/tag/v0.5)
### Issues
- 对接微信-获取微信用户信息
...
## v0.4
[gitee](https://gitee.com/microapp/bxmall/releases/v0.4) [github](https://github.com/microapp-store/bxmall/releases/tag/v0.4)
...
## v0.3
 [gitee](https://gitee.com/microapp/bxmall/releases/v0.3)
### Issues 
- 【后台管理】压缩svg图标
...
## v0.2
 [gitee](https://gitee.com/microapp/bxmall/releases/v0.2) [github](https://github.com/microapp-store/bxmall/releases/tag/v0.2)
### Issues
- 【API】 Token过期自动刷新
...
## v0.1
[gitee](https://gitee.com/microapp/bxmall/releases/v0.1)[github](https://github.com/microapp-store/bxmall/releases/tag/v0.1)
### Issues
...
- 【APP商城】  另外发布了商城的app版本（基于Flutter):bxmall-flutter
