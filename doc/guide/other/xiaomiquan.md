...
## 加入方式：
- 方法1：邀请好友给以下两个项目（gitee上）star 10个(注意是合计10个即可，不是每个10个)即可，然后截图发给作者（微信：myenilu),作者核实过后会邀请你进来。[bxmall](https://gitee.com/microapp/bxmall),[web-flash](https://gitee.com/enilu/web-flash),然后截图发给作者（微信：myenilu),作者核实过后会邀请你进来。
