        ...
        nav: [
            {text: '指南', link: '/guide/base/preface'},
            {
                ...
                items: [
                    {
                        text: "项目", items: [
                            {text: 'bxmall-flutter(app)', link: '/ecosystem/app'},
                            {text: 'bxmall-uniapp', link: '/ecosystem/uniapp'},
            ...
            {text: '捐赠', link: '/donate'},
            {text: 'Gitee', link: 'https://gitee.com/microapp/bxmall'}
        ],
        sidebar: {
            '/guide/': [
                {
